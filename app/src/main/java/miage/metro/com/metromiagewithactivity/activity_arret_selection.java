...
public class activity_arret_selection extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final TextView treatment_message = setPopUpText();
        apiCallGetArrets(treatment_message);
    ...
    /***
     * apiCallGetArrets
     * appel retrofit pour obtenir les arrets, et leur traitement
     * Exemple d'appel pour la ligne B : https://data.metromobilite.fr/api/routers/default/index/routes/SEM:B/clusters
     * @param treatment_message
     */
    private void apiCallGetArrets(final TextView treatment_message) {
        ...
        service.getArrets(currentRoute.getId()).enqueue(new Callback<List<Arret>>() {
            ...
            public void onResponse(Call<List<Arret>> call, Response<List<Arret>> response) {
                if(response.isSuccessful()){
                    ...
                    traitementArrets(arretsTram, arretsString);
            ...
            private void traitementArrets(final List<Arret> arretsTram, final List<String> arretsString) {
